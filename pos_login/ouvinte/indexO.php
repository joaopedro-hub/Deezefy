  ...
  <body>      
      ...
      <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
          ...
          <li><a href="indexO.php">Ouvinte</a></li>
    ...
    <?php
        if(isset($_SESSION['mensagemO'])):?>
        <script>
          //mensagem de alerta
          window.onload = function(){
            M.toast({html: '<?php echo $_SESSION['mensagemO'];?>'})
          };
        </script>
      <?php  
        endif;
        ...
        unset($_SESSION['mensagemO']);
      ?>
        
    <div class="row">
      <div class="col s12 m6 push-m3">
        <h3 class="light">Ouvintes</h3>
        <table class="striped">
          <thead>
            <tr>
              <th>Email:</th>
          ...
          <tbody>
            <?php
              ...
              $sql = "SELECT email,idade,primeiro_nome,sobrenome FROM deezefy.usuario JOIN deezefy.ouvinte USING(email);";
            ...
            <tr>
              ...
              <td><a href="editar_ouvinte.php?id=<?php echo $dados[0]; ?>" title="Editar" class="btn-floating orange"><i class="material-icons">edit</i>
              </a></td>
              ...
              <!-- Modal Structure -->
                <div id="modal<?php echo $dados[0]; ?>" class="modal">
                  <div class="modal-content">
                    <h4>Opa!</h4>
                      <p>Tem certeza que deseja excluir esse ouvinte?</p>
                  </div>
                  <div class="modal-footer">
                  <form action="crud/deleta_ouvinte.php" method="POST">
        ...
        <br>
        <a href="adiciona_ouvinte.php" class="btn">Adiconar Ouvinte</a>
      </div>
    </div>
              <script>
                M.AutoInit();
