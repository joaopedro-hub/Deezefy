...
<html lang="pt-br" dir = "ltr">
  ...
  <body>      
    ...
    <?php
        if(isset($_SESSION['mensagemAL'])):?>
        <script>
          //mensagem de alerta
          window.onload = function(){
            M.toast({html: '<?php echo $_SESSION['mensagemAL'];?>'})
          };
        </script>
      <?php  
        endif;
        ...
        unset($_SESSION['mensagemAL']);
      ?>
        
    <div class="row">
      <div class="col s12 m6 push-m3">
        <h3 class="light">Albuns</h3>
        <table class="striped">
          <thead>
            <tr>
              <th>Título:</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $dados['ano_de_lancamento'];?></td>
              <td><?php echo $dados['Artista_email'];?></td>
              <td><a href="editar_album.php?id=<?php echo $dados[0]; ?>" title="Editar" class="btn-floating orange"><i class="material-icons">edit</i>
              </a></td>
              ...
              <!-- Modal Structure -->
                <div id="modal<?php echo $dados[0]; ?>" class="modal">
                  <div class="modal-content">
                    <h4>Opa!</h4>
                      <p>Tem certeza que deseja excluir esse album?</p>
                  </div>
                  <div class="modal-footer">
                  <form action="crud/deleta_album.php" method="POST">
        ...
        <br>
        <a href="adiciona_album.php" class="btn">Adiconar Album</a>
      </div>
    </div>
              <script>
                M.AutoInit();
